...
@Database(entities = [EventsModel::class, CalendarModel::class], version = 1, exportSchema = false)
...
abstract class CalendarDatabaseBuilder : RoomDatabase() {
    abstract fun calendarDao(): Dao
